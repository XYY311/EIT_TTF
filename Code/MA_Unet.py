...
def MA_Unet_B(basicblock=sim_residual_block, depths=(1, 2, 2, 1, 1, 1), dims=(32, 64, 128, 256, 512, 1024), trans_layers=(4, 1), num_classes=1, input_size=128, use_pos_embed=True):
    model = MAUnet(basicblock=basicblock, depths=depths, dims=dims, trans_layers=trans_layers, num_classes=num_classes, input_size=input_size, use_pos_embed=use_pos_embed)
    return model
